...
class EventTypeController(http.Controller):
    ...
    @http.route('/upcoming-courses', type='http', auth="public", website=True)
    def get_upcoming_courses(self, **kw):
        ...
        return (request.render('website.upcoming-courses-1', {
            'categs_data': categs_data,
        }))

    # # Individual Pages

    @http.route('/courses/ai-emerging-technologies/practical-ai-for-workplace', type='http', auth="public", website=True)
    ...
    def get_upcoming_courses_2(self, **kw):
        ...
        return request.render('website.seo-for-marketers', {
            'events': seo_events,
        })

    @http.route('/courses/marketing-communication/mastering-canva-for-social-media', type='http', auth="public", website=True)
    def get_upcoming_courses_3(self, **kw):
        ...
        return request.render('website.master-canva-for-social-media', {
            'events': events,
        })
    #
    @http.route('/courses/ai-emerging-technologies/ai-for-business-administrators-personal-assistants', type='http', auth="public", website=True)
    ...
    @http.route('/courses/ai-emerging-technologies/blockchain-distributed-ledger-technologies', type='http', auth="public", website=True)
    ...
    #
    @http.route('/courses/leadership-change-delivery/transformative-leadership-programme', type='http', auth="public", website=True)
    ...
    @http.route('/courses/marketing-communication/public-speaking-foundations', type='http', auth="public", website=True)
    ...
    @http.route('/courses/marketing-communication/content-writing-foundations', type='http', auth="public", website=True)
    ...
    @http.route('/courses/ai-emerging-technologies/foundations-ai-marketing', type='http', auth="public", website=True)
    ...
    @http.route('/courses/sales-commercial-leadership/sales-accelerator-foundations', type='http', auth="public", website=True)
    ...
    @http.route('/courses/sales-commercial-leadership/strategic-sales-management-foundations', type='http', auth="public", website=True)
    ...
    @http.route('/courses/leadership-change-delivery/project-management-fundamentals', type='http', auth="public", website=True)
    ...
    @http.route('/courses/leadership-change-delivery/foundations-of-agile-at-scale', type='http', auth="public", website=True)
    ...
    @http.route('/courses/leadership-change-delivery/introduction-cybersecurity', type='http', auth="public", website=True)
    ...
    @http.route('/courses/ai-emerging-technologies/business-intelligence-data-science', type='http', auth="public", website=True)
    ...
    @http.route('/courses/ai-emerging-technologies/ai-social-media', type='http', auth="public", website=True)
