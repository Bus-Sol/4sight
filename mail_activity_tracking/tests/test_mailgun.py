...
_mailgun_test_api_key = "mailgun-test-api-key"
_mailgun_test_signing_key = "mailgun-test-signing-key"
_mailgun_test_validation_key = "mailgun-test-validation-key"
...
class TestMailgun(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cf.mail_tracking_mailgun_api_key = _mailgun_test_api_key
        cf.mail_tracking_mailgun_webhook_signing_key = _mailgun_test_signing_key
        cf.mail_tracking_mailgun_validation_key = _mailgun_test_validation_key
        ...
        config.execute()
        cls.token = "mailgun-test-token"
        cls.timestamp = "1471021089"
        cls.signature = (
            "08e70f741ddb82d447fd2ee409d6c2c151125282ab9ed8e6b53589a69ef249e3"
        )
        cls.event = {
            "log-level": "info",
    ...
    def test_bad_ts(self):
        ...
        self.signature = (
            "30d0e3da74635cfa00dd4bcb2fc47227e302715fa02e1f1646dd60c27d37d75c"
        )
