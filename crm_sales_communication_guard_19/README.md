# CRM Sales Communication Guard — Odoo 19

Commercial-ready CRM communication control for Odoo 19.
...
`crm_sales_communication_guard_19`

Replace the old folder contents in Git, push, and upgrade the module:

```bash
odoo-bin -d YOUR_DATABASE -u crm_sales_communication_guard_19 --stop-after-init
```
